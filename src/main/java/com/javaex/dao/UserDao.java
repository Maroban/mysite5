...
public class UserDao {
  ...
  public UserVo getUserLogin(UserVo userVo) {
    System.out.println("[사용 메소드: UserDao.selectUser()]");
  ...
  public void insert(UserVo userVo) {
    System.out.println("[사용 메소드: UserDao.insert()]");
  ...
  public UserVo getUserModify(UserVo userVo) {
    System.out.println("[사용 메소드: UserDao.getUserModify()]");
  ...
  public UserVo idCheck(String id) {
    System.out.println("[사용 메소드: UserDao.idcheck(" + id + ")]");
